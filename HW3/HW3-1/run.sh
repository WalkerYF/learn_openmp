...
CACHE_FLAG=NO_CACHE
g++$EXE $FILE_NAME -o a.exe -fopenmp -std=c++11 -D DELAY_MIN_TIMES=$DELAY_MIN_TIMES -D DELAY_MAX_TIMES=$DELAY_MAX_TIMES -D $CACHE_FLAG
echo "complie completed!"

echo "cache_flag,schedule, chunk_num, delay_times, cputime, walltime" >> $SAVE_DATA_FILE
